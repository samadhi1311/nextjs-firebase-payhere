	...
	return (
		<div className='grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]'>
			<main className='flex flex-col items-center row-start-2 gap-8 sm:items-start'>
				<h1 className='text-5xl font-medium tracking-tighter text-transparent bg-gradient-to-b from-gray-100 to-gray-400 bg-clip-text'>Next.JS + Firebase + Stripe</h1>
